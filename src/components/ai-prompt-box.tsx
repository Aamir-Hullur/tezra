...
import { ChevronDown, Sparkles, Brain, MessageSquare, Zap } from "lucide-react";
...
const ModelSelector: React.FC<ModelSelectorProps> = ({
  ...
  const getCurrentProviderAndModel = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={cn(
          "rounded-full transition-all flex items-center gap-2 px-3 py-1 border h-8 min-w-0",
          "bg-transparent border-[#444444] text-[#9CA3AF] hover:text-[#D1D5DB] hover:border-[#666666]"
        )}
      >
        <div className="w-4 h-4 flex items-center justify-center flex-shrink-0">
          <CurrentIcon
            ...
            style={{
              color:
                modelData[currentProvider as keyof typeof modelData]?.color,
            }}
          />
        </div>
        <span className="text-xs truncate max-w-20">{currentModel?.name}</span>
        <ChevronDown
          className={cn(
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-full mb-2 left-0 z-50 bg-[#1F2023] border border-[#333333] rounded-xl shadow-xl overflow-hidden"
            style={{
              width: selectedProvider ? "720px" : "320px",
              maxWidth: "calc(100vw - 32px)",
            }}
          >
            <div className="flex">
              {/* Level 1: Providers List */}
              <div className="flex-shrink-0 w-80 p-4 border-r border-[#333333]">
                <div className="text-xs text-gray-400 px-2 py-1 font-medium mb-3">
                  Select Provider
                </div>
                <div className="space-y-2">
                  {Object.entries(modelData).map(([providerId, provider]) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected
                            ? "bg-[#2A2D31] text-white border border-[#444444]"
                            : "hover:bg-[#2A2D31]/50 text-gray-300 hover:text-white"
                        )}
                      >
                        <div
                ...
                {selectedProvider && (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      >
                        {React.createElement(
                          modelData[selectedProvider as keyof typeof modelData]
                            ?.icon,
                          {
                            className: "w-4 h-4",
                            style: {
                      ...
                      {modelData[
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "relative p-4 rounded-xl transition-all text-left border group",
                              "bg-[#2A2D31] hover:bg-[#3A3D41]",
                              isCurrentModel
                                ? "border-green-500 bg-[#2A2D31] ring-1 ring-green-500/20"
                          ...
                          >
                            ...
                            {/* Capability badges */}
                            <div className="flex items-center gap-2">
                              <div className="w-6 h-6 rounded-full bg-[#3A3D41] flex items-center justify-center">
...
>((props, ref) => {
  ...
  const [selectedModel, setSelectedModel] = React.useState("gemini-flash-2.0");
            ...
            {!isRecording && (
              <PromptInputAction tooltip="Voice message">
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8 rounded-full bg-transparent hover:bg-gray-600/30 text-[#9CA3AF] hover:text-[#D1D5DB]"
            ...
            >
              <Button
                ...
                onClick={() => {
                  ...
                  else if (hasContent || !isRecording) handleSubmit();
                }}
